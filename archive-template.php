...
?>
				...
				if ( $arke_posts->have_posts() ) :
					...
					echo '<div class="archives__list">';
					while ( $arke_posts->have_posts() ) :
						$arke_posts->the_post();

						echo '<div class="archives__title"><a href="' . esc_url( get_the_permalink() ) . '">' . get_the_title() . '</a><div class="archives__date">' . esc_attr( get_the_time( 'F j, Y' ) ) . '</div></div>';
